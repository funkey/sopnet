...
//#include <sopnet/training/io/StructuredProblemWriterAcessor.h>
...
util::ProgramOption optionWriteStructuredProblem( 
                ...
                _short_name       = "wSP",
                _description_text = "Write output for structured learning",
...
int main(int optionc, char** optionv) {
	...
	try {
		...
		if (optionWriteStructuredProblem) { 
			...
			//boost::shared_ptr<StructuredProblemWriterAcessor> spWriterAcessor = boost::make_shared<StructuredProblemWriterAcessor>("./labels.txt",
			//														       "./features.txt",
			//														       "./constraints.txt");

                        //spWriterAcessor->setInput("structured problem writer",sopnet->getOutput("structured problem writer"));
                        //spWriterAcessor->write();
